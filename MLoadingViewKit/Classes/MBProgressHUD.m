...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
        ...
        self.loadingAnimationType = PPLoadingAnimationViewTypeWhite;
		self.labelText = nil;
...
- (void)updateIndicators {
	...
	if (mode == MBProgressHUDModeIndeterminate) {
		if (!isActivityIndicator) {
            ...
            self.indicator = [[PPLoadingAnimationView alloc]initWithLoadingType:self.loadingAnimationType];
...
- (NSArray *)observableKeypaths {
	return [NSArray arrayWithObjects:@"mode",@"loadingAnimationType", @"customView", @"labelText", @"labelFont", @"labelColor",
...
- (void)updateUIForKeypath:(NSString *)keyPath {
	if ([keyPath isEqualToString:@"mode"]|| [keyPath isEqualToString:@"loadingAnimationType"] || [keyPath isEqualToString:@"customView"] ||
...
@implementation PPLoadingAnimationView

#pragma mark - Lifecycle

- (id)initWithLoadingType:(PPLoadingAnimationViewType)type{
    return [self initWithFrame:CGRectMake(0.0f, .0f, 40.0f, 40.0f) type:type];
}

- (id)initWithFrame:(CGRect)frame
               type:(PPLoadingAnimationViewType)type{
    self = [super initWithFrame:frame];
    if (self) {
...
- (void)setLoadingType:(PPLoadingAnimationViewType)loadingType
{
